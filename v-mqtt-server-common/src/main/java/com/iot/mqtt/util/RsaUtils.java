...
public class RsaUtils {
    ...
    public static void main(String[] args) {
        ...
        String rsaPublicKey = stringStringMap.get(RsaUtils.PUBLIC_KEY);
        String rsaPrivateKey = stringStringMap.get(RsaUtils.PRIVATE_KEY);
        System.out.println("rsaPublicKey : " + rsaPublicKey);
        System.out.println("rsaPrivateKey : " + rsaPrivateKey);
        String encrypt = RsaUtils.encrypt("password", rsaPublicKey);
