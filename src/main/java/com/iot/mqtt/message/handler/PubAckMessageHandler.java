...
public class PubAckMessageHandler extends BaseMessageHandler<MqttPubAckMessage> {
    ...
    public PubAckMessageHandler(ApplicationContext context, ClientSession clientSession) {
    ...
    public void handle(MqttPubAckMessage mqttPubAckMessage) {
        // 收到应答包，删除重试消息
        dupPublishMessageManager.remove(clientSession.getClientId(), mqttPubAckMessage.messageId());
    }
}
